            ...
            <section>
                ...
                <div className="stat-card">
                    ...
                    <ul className="checklist">
                        ...
                        <li>
                            <span
                                className={`mark ${summary.adultMeetsAForm ? "ok" : "bad"
                                    }`}
                            >
                        ...
                        <li>
                            <span
                                className={`mark ${summary.adultMeetsAResearch ? "ok" : "warn"
                                    }`}
                            >
                        ...
                        <li>
                            <span
                                className={`mark ${summary.adultImpairmentTwoDomains === true ? "ok" : "bad"
                                    }`}
                            >
                        ...
                        <li>
                            <span
                                className={`mark ${summary.childImpairmentTwoDomains === true ? "ok" : "bad"
                                    }`}
                            >
